    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="font-semibold text-xl leading-tight dark:text-white">Products</h2>
                <Link
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div>
                    <ProductCard  v-for="product in products" :key="product.id" :product="product" class="border border rounded mb-4 hover:bg-gray-200" />
                </div>
            </div>
        </div>
    </AuthenticatedLayout>

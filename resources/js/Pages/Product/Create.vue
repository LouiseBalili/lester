        ...
        <div class="py-12">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8 flex items-center">
                ...
                <div class="bg-white dark:bg-[#1f1f1f] overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <h2 class="font-semibold text-lg text-gray-800 dark:text-white leading-tight text-center">Product Details</h2>
                        ...
                        <button class="px-4 py-2 text-sm rounded-md bg-gray-500 text-white">Create Product</button>
                    </div>
                </div>
            </div>
        </div>
